public class B2_Inheritance {
        /*
         ...
         in it. After all, computer programming is all for re-usability of code. So in our new class
         (subclass) of Apple laptops we could "inherit" all the methods and field variables present in the
         computer "superclass".

         Superclass - The class from which we inherit.
         Subclass - The class in which we inherit.
         Inheritance is an important pillar for OOP and Java. Inheritance allows us the re-usability of code.
         ...
         now.
         Let me clear a few of the confusions for you.
