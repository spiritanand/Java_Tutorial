public class B3_Composition {
    /*
     ...
     Porsche 911 "is a" Car (super class), whereas its doors, its engine and its headlights are not
     ...
     Let's now take the example of the class Car. Car has the components of a body and engine(for the sake of
     simplicity). Now the class of body and engine are "not" the super class of Car as a Car is neither.
     
     Let's look at the class of Engine (B3_C_Engine).
    */
}
